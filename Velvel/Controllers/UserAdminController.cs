...
namespace IdentitySample.Controllers
{
    ...
    public class UsersAdminController : Controller
    {
        ...
        public ActionResult Managers()
        {
            ...
            return View(identityDb.Managers.ToList());
        }
        ...
        public async Task<ActionResult> Create(RegisterViewModel userViewModel, params string[] selectedRoles)
        {
            if (ModelState.IsValid)
            {
                ...
                if (selectedRoles.Contains("Manager"))
                {
                    ...
                    //user.UserId = user.ManagerId;
                }
                if (selectedRoles.Contains("Customer"))
                {
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,Phone")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
